...
<html lang="en">
  <head>
    ...
    <title>ALL THINGS DALLAS COLLEGE</title>
    <link
  ...
  <body>
    <nav
      class="navbar navbar-expand-lg bg-body-tertiary blueGradientBackground"
      data-bs-theme="dark"
    >
      <div class="container-fluid">
        <a class="navbar-brand" href="#">All Things Dallas College</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="blogcentral.html">Blogs</a>
            </li>
            <li class="nav-item">
